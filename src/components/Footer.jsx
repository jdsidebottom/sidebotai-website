        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/#custom-development" className="text-white/70 hover:text-white transition-colors">Custom Development</Link></li>
              <li><Link to="/#ai-solutions" className="text-white/70 hover:text-white transition-colors">AI Solutions</Link></li>
              <li><Link to="/#consulting" className="text-white/70 hover:text-white transition-colors">Consulting</Link></li>
              <li><Link to="/#prototyping" className="text-white/70 hover:text-white transition-colors">Prototyping</Link></li>
            </ul>
          </div>
